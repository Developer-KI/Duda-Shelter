...
import 'package:duda_shelter/pages/Main/AdoptPage.dart';
import 'package:duda_shelter/pages/Main/DonatePage.dart';
...
class _OurMainPageState extends State<OurMainPage> {
  ...
  DrawerItem item = DrawerItems.adopt;
  DrawerItem currentItem = DrawerItems.adopt;
  ...
  Widget getDrawerPage() {
    switch (item) {
      case DrawerItems.donate:
        return OurDonatePage(
          openDrawer: openDrawer,
        );

      case DrawerItems.adopt:
      default:
        return OurAdoptPage(
          openDrawer: openDrawer,
        );
